...
class ShuffleNetV2(nn.Module):
    def __init__(
        ...
        print("Jia-Baos, model_size is ", model_size)
        print("Jia-Baos, out_stages is ", out_stages)
        print("Jia-Baos, activation is ", activation)
        print("Jia-Baos, pretrain is ", pretrain)
