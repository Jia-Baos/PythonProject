...
def parse_args():
    ...
    parser.add_argument(
        "--config",
        default="/home/jia-baos/Project-Python/nanodet/config/nanodet-plus-m-1.5x_416.yml",
        help="model config file path",
    )
    parser.add_argument(
        "--model",
        default="/home/jia-baos/Project-Python/nanodet/pth/nanodet-plus-m-1.5x_416.pth",
        help="model file path",
    )
    parser.add_argument(
        "--path",
        default="/home/jia-baos/Project-Python/nanodet/imgs/1.png",
...
def main():
    ...
    logger.log("args.config: " + args.config)
    logger.log("args.model: " + args.model)
    logger.log("args.path: " + args.path)
    logger.log("args.save_result: " + str(args.save_result))
    ...
    if args.demo == "image":
        ...
        for image_name in files:
            ...
            if args.save_result:
                ...
                logger.log("save_folder: " + save_folder)
